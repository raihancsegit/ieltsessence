...
export const coursesData: Course[] = [
  ...
  // --------------------------------------------------------------------------
  {
    ...
    title: "Professional Writing & Speaking Mastery",
    subHeadline: "Writing + Speaking Complete Mastery",
    tagline: "Writing এবং Speaking-এ কাঙ্ক্ষিত ব্যান্ড ৭.৫+ নিশ্চিত করার জন্য সমন্বিত স্পেশালাইজড কম্বো মাস্টার প্রোগ্রাম।",
    category: "Fast-Track Program",
    badge: "Mastery Pack • 35 Classes",
    badgeColor: "bg-amber-500 text-white",
    duration: "2 Months Class Support + 3 Months Practice Support",
    totalClasses: "35 Classes",
    mockTests: "8 Combined Mocks",
    price: "৳ ৭,৯৯৯",
    originalPrice: "৳ ১২,০০০",
    targetBand: "Band 7.0 – 8.5+",
    overview: "Writing এবং Speaking মডিউলে আটকে থাকা স্কোরকে ৭.৫+ এ উন্নীত করার জন্য সমন্বিত ও নিবিড় প্রফেশনাল মাস্টার প্রোগ্রাম।",
    highlights: [
      "35 Dedicated Master Classes for Writing & Speaking",
      "Line-by-line task corrections & daily speaking simulation",
      "Dedicated Expert Mentors for Writing and Speaking",
      "Cambridge Traps & Fluency Boost Techniques",
      "8 Targeted Skill-based Mock Tests with Performance Breakdown",
      "২ মাস ক্লাস সাপোর্ট + ৩ মাস প্র্যাকটিস সাপোর্ট"
    ],
    features: [
